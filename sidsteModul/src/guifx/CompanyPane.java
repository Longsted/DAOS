...
public class CompanyPane extends GridPane {
    ...
    public CompanyPane() {
        ...
        //listen af ansatte i virksomheden
    ...
    private void deleteAction() {
        ...
        String s = " ";
        if (company != null) {
            if(Controller.getNumberOfEmp(company)== 0){
                ...
                alert.setTitle("Delete Company");
                s = Controller.deleteCompany(company);
    ...
    public void updateControls() {
        ...
        if (company != null) {
            ...
            for (Employee emp : Controller.getEmpForComp(company.getId())) {
                sb.append(emp + "\n");
            }
