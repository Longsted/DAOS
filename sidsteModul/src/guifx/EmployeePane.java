...
public class EmployeePane extends GridPane {
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			if (Controller.getCompanyForEmp(employee) != null) {
				txfCompany.setText(Controller.getCompanyForEmp(employee));
				txfSalary.setText("kr " + Controller.weeklySalary(employee));
			} else {
				txfCompany.clear();
				txfSalary.clear();
			}
